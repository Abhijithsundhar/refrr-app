...
class UpdateCreditPage extends StatefulWidget {
  ...
  const UpdateCreditPage({super.key, required this.title, required this.amount, required this.date,
    required this.image, required this.description, required this.currency,required this.affiliate});

  @override
  State<UpdateCreditPage> createState() => _UpdateCreditPageState();
}
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Credits', style: GoogleFonts.roboto(
                      fontSize: width * 0.06,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            width: width*.75,
                            color: Colors.red,
                            child: widget.image.isNotEmpty?Image.asset(widget.image,fit: BoxFit.fill,)
                                : Image.asset('assets/images/withdrewImageHome.jpeg'),
                       ...
                       formattedDescription.isNotEmpty? SizedBox(height: height*.03,):SizedBox(),
                        ///description
                        formattedDescription.isNotEmpty? Padding(
                          padding: EdgeInsets.only(left: width * .06),
                          child: Text(
