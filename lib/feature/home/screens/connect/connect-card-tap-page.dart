...
class ConnectInnerPage extends StatefulWidget {
  final LeadsModel lead;
  const ConnectInnerPage({super.key, required this.lead});

  @override
  State<ConnectInnerPage> createState() => _ConnectInnerPageState();
}

class _ConnectInnerPageState extends State<ConnectInnerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /// ✅ Fixed Bottom Button like bottom bar
