              ...
              Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding:  EdgeInsets.only(top: height*.04,left: width*.06),
                      child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    obscureText: _obscurePassword, // 👈 hides/shows text
                                    style: TextStyle(color: Colors.grey),
                                    decoration: InputDecoration(
                                      hintText: 'Password',
                                      hintStyle: TextStyle(color: Colors.grey),
                              ...
                              Padding(
                                ...
                                child:Text('Forgot password',style: GoogleFonts.roboto(
                                  fontWeight: FontWeight.w400,color: ColorConstants.appBlue,
                                  fontSize: width*.033,decoration: TextDecoration.underline,
                                  decorationColor: ColorConstants.appBlue,decorationThickness: 1.5,
                                ),),
                              ),
